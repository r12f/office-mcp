...
test('Windows packaging includes the tray controller in portable payload', () => {
  ...
  assert.match(buildScript, /install-user\.ps1/);
  assert.match(buildScript, /uninstall-user\.ps1/);
  assert.match(buildScript, /start-daemon\.ps1/);
...
test('Release notes document the Windows portable pre-release gate', () => {
  ...
  assert.match(releaseNotes, /uninstall-user\.ps1/);
