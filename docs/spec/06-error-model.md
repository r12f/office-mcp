...
| -32401 | `AUTH_TOKEN_INVALID` | (Add-in registration only.) Bearer token does not match. |
| -32402 | `AUTH_TOKEN_MISSING` | (HTTP transport with `--api-key`.) Client did not present a key. |
