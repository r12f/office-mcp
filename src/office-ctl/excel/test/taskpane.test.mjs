...
test('Excel task pane uses common channel and registers Excel runtime metadata', () => {
  ...
  assert.match(js, /async function updateRangeStructure/);
  ...
  assert.match(js, /async function updateRangeStructure\(args\)/);
  assert.match(js, /const action = rangeStructureActionFrom\(args\.action\)/);
  assert.match(js, /validateRangeStructureShift\(args\.address, action, shift\)/);
  assert.match(js, /const updateTarget = rangeStructureAddress\(range, shift, args\.count\)/);
  assert.match(js, /updateTarget\.insert\(insertShiftDirectionFrom\(shift\)\)/);
  assert.match(js, /updateTarget\.delete\(deleteShiftDirectionFrom\(shift\)\)/);
  assert.match(js, /function insertShiftDirectionFrom\(value\)/);
  assert.match(js, /function deleteShiftDirectionFrom\(value\)/);
  assert.match(js, /function rangeStructureActionFrom\(value\)/);
  assert.match(js, /function validateRangeStructureShift\(address, action, shift\)/);
  assert.match(js, /function rangeStructureAddress\(range, shift, count\)/);
  assert.match(js, /function rangeStructureCount\(value\)/);
  ...
  assert.match(js, /deprecation_warning: 'excel\.clear_range delete_shift is superseded by excel\.update_range_structure with action delete\.'/);
