...
async function main(): Promise<void> {
  ...
  try {
    ...
    await assertEval(cdp, 'document.querySelector("[data-copy=\\"logPath\\"]").getAttribute("aria-label") === "Copy log path" && document.querySelector("#logPath").closest("button") === null && getComputedStyle(document.querySelector("#logPath")).userSelect !== "none"', 'log path is selectable text with a separate copy affordance');
