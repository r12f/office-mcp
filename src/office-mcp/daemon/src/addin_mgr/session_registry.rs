use crate::addin_mgr::session_registry_model::{
    AddinConnectionState, infer_capability_tiers, normalize_host_app,
};
use crate::addin_mgr::{
    DocumentDescriptor, HostDescriptor, InvocationPermit, NewSessionInfo, OfficeMcpCode,
    RegistrationOutcome, RuntimeInfo, SessionDescriptor, SessionDetails, SessionInfo, SessionPatch,
    SessionStatus, ToolInvocationError,
};
